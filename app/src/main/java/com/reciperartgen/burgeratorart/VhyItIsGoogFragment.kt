...
class VhyItIsGoogFragment : Fragment() {
    private var _binding: FragmentVhyItIsGoogBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVhyItIsGoogBinding.inflate(inflater, container, false)
        return binding.root
    }
